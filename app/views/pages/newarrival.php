...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <meta name="keywords" content=" furniture,cloth covered accent chair,valvet accent arm chair,mapple wood accent chair">
		<meta name="keyword" content="Wooden Chair,Single Armchair, Wooden Armchair,Stylish Chair,Modern Chair,Mapple Wood ,Dinning Table, Arm Chair, Wooden Bed ">
...
<section id="new-arrivals" class="new-arrivals">
    <div class="container">
        <div class="section-header">
            <h1 class="new-arrival">new arrivals</h1>
        </div><!--/.section-header-->
